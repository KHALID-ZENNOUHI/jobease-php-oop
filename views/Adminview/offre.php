                ...
                <table class="agent table align-middle bg-white" style="min-width: 700px;">
                    ...
                    <tbody>
                        ...
                        <tr class="freelancer">
                            ...
                            <td class="">
                                    <a href="#editjobmodal<?php echo $job['job_id']?>" data-bs-toggle="modal"><img class="accept_task w-50" src="Assets/img/journal-check.svg" alt="icon"></a>
                                    <a href="/jobdelete?jobid=<?= $job['job_id']?>"><img class="delet_user w-50" src="Assets/img/journal-x.svg" alt="icon"></a>
                            </td>
                        </tr>
                        <?php
                        }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method  = "POST" enctype = "multipart/form-data" action = "/job" autocomplet = "off">
          <div class="mb-3">
